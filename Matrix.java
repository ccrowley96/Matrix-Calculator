...
public void cofactorAndminor() {
	double[][] temp = new double[this.m_rows][this.n_cols];
	for (int i = 0; i < this.m_rows; i++){
		for (int j = 0; j < this.n_cols; j++){
    ...
    this.arr[0][0] = (temp[1][1]*temp[2][2]) - (temp[2][1]*temp[1][2]);
    this.arr[0][1] = -1*((temp[1][0]*temp[2][2]) - (temp[2][0]*temp[1][2]));
    this.arr[0][2] = (temp[1][0]*temp[2][1]) - (temp[2][0]*temp[1][1]);
    this.arr[1][0] = -1*((temp[0][1]*temp[2][2]) - (temp[2][1]*temp[0][2]));
    this.arr[1][1] = (temp[0][0]*temp[2][2]) - (temp[2][0]*temp[0][2]);
    this.arr[1][2] = -1*((temp[0][0]*temp[2][1]) - (temp[2][0]*temp[0][1]));
    this.arr[2][0] = (temp[0][1]*temp[1][2]) - (temp[1][1]*temp[0][2]);
    this.arr[2][1] = -1*((temp[0][0]*temp[1][2]) - (temp[1][0]*temp[0][2]));
    this.arr[2][2] = (temp[0][0]*temp[1][1]) - (temp[1][0]*temp[0][1]);     
